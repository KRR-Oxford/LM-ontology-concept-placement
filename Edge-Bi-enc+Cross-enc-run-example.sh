...
./Edge-Bi-enc+Cross-enc.sh Disease true 50 25 16 true 200000 false > results_log_Disease_edge_biencoder_top50_200k_final.txt
...
./Edge-Bi-enc+Cross-enc.sh Disease false 50 25 16 true 200000 false > results_log_Disease_edge_biencoder_top50_200k_final_w_o_ctx.txt
...
./Edge-Bi-enc+Cross-enc.sh CPP true 10 5 16 true 200000 false > results_log_Disease_edge_biencoder_top10_200k_final.txt
