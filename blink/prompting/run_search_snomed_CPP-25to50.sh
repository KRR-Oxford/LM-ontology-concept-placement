...
## embedding-based
# top-50 from 25
# python prompting_embedding_edges.py --snomed_subset CPP --edge_ranking_by_score --enrich_cands --pool_size 50 --pool_size_seed 25 --pool_size_edge_lvl 50 --enrich_edges --data_split valid-NIL > log-CPP-results-25to50-fixed-embedding-ranking-enrich-ori-target-sapbert-valid-NIL-new.txt

# python prompting_embedding_edges.py --snomed_subset CPP --edge_ranking_by_score --enrich_cands --pool_size 50 --pool_size_seed 25 --pool_size_edge_lvl 50 --enrich_edges --data_split test-NIL > log-CPP-results-25to50-fixed-embedding-ranking-enrich-ori-target-sapbert-test-NIL-new.txt
...
## idf-based
# top-50 from 25
python prompting_embedding_edges.py --snomed_subset CPP --edge_ranking_by_score --enrich_cands --pool_size 50 --pool_size_seed 25 --pool_size_edge_lvl 50 --enrich_edges --use_idf_score_for_cand --use_idf_score_for_edges --data_split valid-NIL > log-CPP-results-25to50-idf-ranking-enrich-valid-NIL-new.txt

python prompting_embedding_edges.py --snomed_subset CPP --edge_ranking_by_score --enrich_cands --pool_size 50 --pool_size_seed 25 --pool_size_edge_lvl 50 --enrich_edges --use_idf_score_for_cand --use_idf_score_for_edges --data_split test-NIL > log-CPP-results-25to50-idf-ranking-enrich-test-NIL-new.txt
